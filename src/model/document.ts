...
export async function readDocumentsFirstQuery(
...
export async function readDocumentsQuery(
  params: ReadDocumentsQuery
): Promise<Document[]> {
  ...
  const result = await pool.query<Document>(query, [userID, cursor, id, limit]);

  return result.rows;
}

export async function readDocument(id: number): Promise<Document> {
...
export async function findDocumentsFirstQuery(
...
export async function findDocumentsQuery(
  params: FindDocumentsQuery
): Promise<Document[]> {
...
export async function updateDocument(params: UpdateDocument) {
...
export async function deleteDocumentHashtag(id: number) {
